...
final class Version20250903190544 extends AbstractMigration
{
    ...
    {
        return 'Rename sylius_adyen_token → sylius_adyen_shopper_reference in MySQL without data loss';
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sylius_adyen_shopper_reference RENAME INDEX idx_90dd13305aa1164f TO IDX_FEDC250A5AA1164F');
        $this->addSql('ALTER TABLE sylius_adyen_shopper_reference RENAME INDEX idx_90dd13309395c3f3 TO IDX_FEDC250A9395C3F3');
        $this->addSql('ALTER TABLE sylius_adyen_shopper_reference RENAME INDEX uniq_90dd1330772e836a TO UNIQ_FEDC250A772E836A');
    }
}
